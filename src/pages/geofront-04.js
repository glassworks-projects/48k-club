  ...
  render () {
    return (
      <ImgAbout
        ...
        gf={true}
        images={[
          <div><img src={require("../media/gf04/gf04-01.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-02.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-03.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-04.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-05.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-06.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-07.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-08.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-09.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-10.jpg")} alt="event"/></div>,
          <div><img src={require("../media/gf04/gf04-11.jpg")} alt="event"/></div>
          ]
        }
        text={[
